// ไฟล์แปลงค่าดิบจาก API ให้เป็นข้อความที่คนอ่านง่ายบน panel และ popup
(function (window) {
  ...
  function formatDistance(value) {
    // ระยะน้อยกว่า 1000 เมตรแสดงเป็นเมตร เกินกว่านั้นแสดงเป็นกิโลเมตร
  ...
  function formatAccuracy(value) {
    // ความแม่นยำ GPS มาจากเมตรจริงของอุปกรณ์ ไม่ใช่ค่าประมาณจาก UI
  ...
  function formatThaiDate(value) {
    // แปลงวันที่ ISO ให้เป็นวันที่ไทย เพื่ออ่านง่ายใน summary card
    const text = formatValue(value);
